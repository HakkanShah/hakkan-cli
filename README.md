...
- **Instant Terminal Portfolio**: A quick, geeky way to introduce myself.
- **Tech Stack**: See what technologies I work with.
- **Social Links**: Quick access to my GitHub, LinkedIn, and Website.
- **Styled Output**: Beautifully formatted using `chalk`.
